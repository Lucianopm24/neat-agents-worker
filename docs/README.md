...
| [`mail.md`](./mail.md) 📮 | **Neat Mail** (v2): el correo vive en Neat — buzón auto @neat.qzz.io, claim 1×@is-so.pro, webmail mail.neat.blue / mail.is-so.pro, panel admin total, auth dual (humano+agente) | `mail/index.js` · `mail/page.js` · `mail/mime.js` |
